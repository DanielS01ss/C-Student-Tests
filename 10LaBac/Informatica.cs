...
namespace _10LaBac
{
    ...
    public partial class Informatica : Form
    {
           ...
           if(ras_ales.Length ==0)
            ...
            else
            {
                ...
                if(p == 9)
                {
                    ...
                    sqlDA.Fill(dtUser);
                    medie_rom = Double.Parse(dtUser.Rows[0]["medie_info"].ToString());
                    ...
                    if(nota>medie_rom)
                    {
                        ...
                        using (SqlConnection sqlCon = new SqlConnection(connString))
                        {
                            ...
                            sqlCmd.Parameters.AddWithValue("@info", nota);
        ...
        void populare()
        {
            ...
            string comm = "SELECT * FROM UserRegistrationDB.dbo.TestInfo";
            SqlConnection sqlConn = new SqlConnection(connString);
            SqlDataAdapter sqlDA = new SqlDataAdapter(comm, sqlConn);
